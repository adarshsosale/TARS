"""Project-level training wrapper for RSL-RL (Hexabot).

Drop-in replacement for external/IsaacLab/scripts/reinforcement_learning/rsl_rl/train.py
that:
  1. Registers the Hexabot task (from isaac_lab/tasks/) instead of requiring it to
     live inside the vendored IsaacLab package.
  2. Routes log output to <project_root>/logs/ instead of external/IsaacLab/logs/.

Usage (from any directory):
    cd external/IsaacLab
    ./isaaclab.sh -p ../../isaac_lab/train_hexabot.py --task Isaac-Velocity-Flat-Hexabot-Direct-v0 --headless
"""
